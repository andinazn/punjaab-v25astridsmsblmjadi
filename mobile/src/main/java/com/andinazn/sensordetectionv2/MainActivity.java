...
public class MainActivity extends ActionBarActivity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (emergencyNumber1Fr!=null){
                eN1 = emergencyNumber1Fr;
            }
            Log.i("emergency number 1","emergency nu 1 " + eN1 );


            emergencyNumber2Fr = args.getString("EMERGENCY_NUMBER2");
            if (emergencyNumber2Fr!=null){
                eN2 = emergencyNumber2Fr;
            }
            Log.i("emergency number 2","emergency nu 2 " + eN2 );

            emergencyNumber3Fr = args.getString("EMERGENCY_NUMBER3");

            if (emergencyNumber3Fr!=null){
                eN3 = emergencyNumber3Fr;
            }
            Log.i("emergency number 3","emergency nu 3 " + eN3 );

            emergencyNumber4Fr = args.getString("EMERGENCY_NUMBER4");

            if (emergencyNumber4Fr!=null){
                eN4 = emergencyNumber4Fr;
            }
            Log.i("emergency number 4","emergency nu 4 " + eN4 );

            emergencyNumber5Fr = args.getString("EMERGENCY_NUMBER5");

            if (emergencyNumber5Fr!=null){
                eN5 = emergencyNumber5Fr;
            }
            Log.i("emergency number 5","emergency nu 5 " + eN5 );
                    ...
                    if (sensorType == 1) {
                        ...
                        if (fallconfirmation == false) {
                            ...
                            if (ActivityCompat.checkSelfPermission(getContext(),
                                ...
                                sms2.sendTextMessage(eN2,null, message, null, null);}


                                if(eN3!="0"){
                                    SmsManager sms3 = SmsManager.getDefault();
                                    sms3.sendTextMessage(eN3,null, message, null, null);}

                                if(eN4!="0"){
                                    SmsManager sms4 = SmsManager.getDefault();
                                    sms4.sendTextMessage(eN4,null, message, null, null);}

                                if(eN5!="0"){
                                    SmsManager sms5 = SmsManager.getDefault();
                                    sms5.sendTextMessage(eN5,null, message, null, null);}
                            }
                        }
